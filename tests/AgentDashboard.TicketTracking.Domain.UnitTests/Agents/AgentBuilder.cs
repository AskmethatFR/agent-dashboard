...
internal sealed class AgentBuilder
{
    ...
    public AgentBuilder WithName(AgentName name) { _name = name; return this; }
    public AgentBuilder WithName(string name) { _name = new AgentName(name); return this; }
    public AgentBuilder WithGlyph(AgentGlyph glyph) { _glyph = glyph; return this; }
    public AgentBuilder WithGlyph(string glyph) { _glyph = new AgentGlyph(glyph); return this; }
    public AgentBuilder WithRole(AgentRole role) { _role = role; return this; }
