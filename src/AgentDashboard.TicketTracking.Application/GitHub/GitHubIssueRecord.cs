...
/// Used by the write model's idempotent upsert and persisted as github_url.
/// </param>
/// <param name="UpdatedAt">
/// The timestamp when the issue was last updated.
/// Used by the write model's idempotent upsert and persisted as updated_at_utc.
/// </param>
/// <param name="ClosedAt">
/// The timestamp when the issue was closed, or null if still open.
/// Used by the write model's idempotent upsert and persisted as closed_at_utc.
/// </param>
